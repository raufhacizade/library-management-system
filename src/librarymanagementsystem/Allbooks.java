...
public class Allbooks extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane2.setViewportView(allBooksTable);
        ...
        jPanel1.add(clear, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 470, 160, 50));
    ...
    private void allBooksTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_allBooksTableMouseClicked
        ...
        DefaultTableModel tmodel = (DefaultTableModel) allBooksTable.getModel();
        int rowIndex = allBooksTable.getSelectedRow();
